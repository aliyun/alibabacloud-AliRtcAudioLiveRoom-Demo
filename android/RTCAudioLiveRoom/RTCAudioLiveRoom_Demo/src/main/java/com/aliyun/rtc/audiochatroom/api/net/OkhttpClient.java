package com.aliyun.rtc.audiochatroom.api.net;
...
import com.aliyun.rtc.audiochatroom.utils.PackageUtil;
...
public class OkhttpClient {
    ...
    public <T> void doGet(String url, Map<String, String> params, final BaseHttpCallBack<T> callBack) {
